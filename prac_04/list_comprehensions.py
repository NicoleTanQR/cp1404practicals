...
# and here's the join string method being used to create a single string from
# the names like: 'Ada Alan Angel Bob Jimi'
...
# a list comprehension and the join string method to create a string (not list)
